            ...
            <div className="w-96 bg-indigo-50 rounded-3xl py-20 select-none px-4">
                ...
                <div className="bg-white h-20 mt-16  rounded-2xl py-3">
                    ...
                    <div className="flex mx-4">
                        ...
                        <input className="w-80 ml-4 mt-1 pl-1" type="email" name="email" placeholder="Username@gmail.com" />
                    </div>
                </div>
                <button className="h-10 w-full mt-8 bg-indigo-800 text-white rounded-3xl hover:bg-sky-700 active:bg-indigo-800">發送救援信件</button>
