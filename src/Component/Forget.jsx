        ...
        return (
            <div class="w-96 bg-indigo-50 rounded-3xl py-20 select-none px-4">
                ...
                <div class="bg-white h-20 mt-16  rounded-2xl py-3">
                    <label for="email" class="ml-4">請輸入註冊的Email</label>
                    <div class="flex mx-4">
                ...
                <button class="h-10 w-full mt-8 bg-indigo-800 text-white rounded-3xl">發送救援信件</button>
                <div class=" grid gap-72 grid-cols-2 mt-8"><span class="w-8 cursor-pointer"><Link to="/">登入</Link></span><span class="cursor-pointer"><Link to="/Register">註冊</Link></span></div>
            </div>
        );
    }
}
