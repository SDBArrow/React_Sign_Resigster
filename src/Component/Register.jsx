            ...
            <div className="w-96 bg-indigo-50 rounded-3xl py-20 select-none px-4">
                ...
                <div className="h-20 mt-16 gap-8 flex ">
                    <div className="bg-white rounded-2xl w-40 py-3 ">
                        ...
                        <input className="h-7 w-32 mt-1 ml-4 pl-1" type="firstname" name="firstname" placeholder="Michael" onChange={this.getValue} />
                    </div>
                    <div className="bg-white rounded-2xl w-40 py-3 ">
                        <label className="ml-4">Last name</label>
                        <input className="h-7 w-32 mt-1 ml-4 pl-1" type="lastname" name="lastname" placeholder="Ke" onChange={this.getValue} />
                    </div>
                </div>
                ...
                <div className="bg-white h-20 mt-8  rounded-2xl py-3">
                    ...
                    <div className="flex mx-4">
                        ...
                        <input className="w-80 ml-4 mt-1 pl-1" type="password" name="passwordcheck" placeholder="············" onChange={this.getValue} />
                    </div>
                </div>
                <button className="h-10 w-full mt-8 bg-indigo-800 text-white rounded-3xl cursor-pointer hover:bg-sky-700 active:bg-indigo-800 disabled:bg-black disabled:cursor-default"  disabled="disabled" onClick={this.registeraccount} >註冊</button>
